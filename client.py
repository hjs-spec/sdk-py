...
class HJSClient:
    ...
    def termination(
        ...
        if target_type not in ['judgment', 'delegation']:
            raise ValueError("target_type must be 'judgment' or 'delegation'")
    ...
    def verification(
        ...
        if target_type not in ['judgment', 'delegation', 'termination']:
            raise ValueError("target_type must be 'judgment', 'delegation', or 'termination'")
